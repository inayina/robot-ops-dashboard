...
try:
    MOTOR_CMD_MAX_ABS_RPM = float(os.getenv("MOTOR_CMD_MAX_ABS_RPM", "300"))
except ValueError:
    MOTOR_CMD_MAX_ABS_RPM = 300.0
...
try:
    MOTOR_CMD_MAX_PWM_LIMIT = float(os.getenv("MOTOR_CMD_MAX_PWM_LIMIT", "0.5"))
except ValueError:
    MOTOR_CMD_MAX_PWM_LIMIT = 0.5
